 ...
 * under the License.
 */
package org.os890.bv.addon.label.test.uc.uc003.infrastructure;
...
public class InMemoryTypedMessageStorage implements TestMessageStorage {
    ...
    protected void init() {
        ...
        messageCodeToTextMap.put("VIOLATION_01", "[1] The length of '{propertyLabel}' should be between {min} and {max}");
        messageCodeToTextMap.put("VIOLATION_02", "[2] The length of '{propertyLabel}' should be between {min} and {max}");
